...
function teste(method, dataset_id)
   ...
   for it = 1 : iter_num
     ...
     switch method
        case 'CGRASP_clu'
           [fval x fconv] = CGRASP_clu(dpaths{id}, lengths{id}, k{id}, dim{id}, 2, maxdirtotry, delta1, delta2);
        case 'CGRASP_2007'
           [fval x fconv] = CGRASP_2007(dpaths{id}, lengths{id}, k{id}, dim{id}, 2, maxiters, maxnumiternoimprov, maxdirtotry, alfa); 
        case 'GA_clu'
           [fval x fconv] = GA_clu(dpaths{id}, lengths{id}, k{id}, dim{id}, 2); 
        case 'TS_clu'
           [fval IDX fconv] = TS_clu(dpaths{id}, lengths{id}, k{id}, dim{id}, 2);
           IDX = IDX';
        case 'PSO_clu'
           [fval x fconv] = PSO_clu(dpaths{id}, lengths{id}, k{id}, dim{id}, 2);
        case 'kmeans'
